"""Build a unified disaster-event representation from vision, topology, and NLP signals."""
...
def build_event(
    ...
    return {
        ...
        "topology_validation": normalize_topology(topology),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Week 15: fuse satellite, topology, and social-media event signals.")
    ...
    topology = read_json(args.topology_json, {"validated": True, "topology_confidence": 0.81})
    social = read_json(
        args.social_json,
        {
