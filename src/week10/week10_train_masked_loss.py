"""Train Week 10A building-masked damage-loss experiments."""
...
def main() -> None:
    ...
    if args.experiment_name is None:
        args.experiment_name = "experiment_week10a_building_masked_damage_loss"
    args.results_root = Path("results") / "week10"
    args.damage_loss = "building_masked_ce_dice"
